...
<div class="container form">
	<div class="row">
		<div class="col-md-4 hid col-sm-2">
			Abam Gwapo<!-- hidden text -->
		</div>
		<div class="col-md-4 cont border rounded-3 col-sm-8">
			<h1>Thank You !</h1>
			<p>
				Thank you <span class="fw-bold">${email}</span> for your
				registration. <br> A litte more and you're good to go
			</p>
